...
public class ScheduleDeleteRequest extends StringRequest {
    ...
    final static private String URL = "http://192.168.43.34/Schedule/delete_schedule.php";
    private Map<String,String> parameters;

    public ScheduleDeleteRequest(String master_key,String name, String year, String month,String day, String schedule_content, String schedule_content_detail,
